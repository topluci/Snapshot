...
Requires Fabric Loader 0.19.2+, Fabric API 0.152.2+26.2+, and Java 25. OpenGL is tested; Minecraft's
built-in experimental Vulkan backend is expected to be compatible but is not yet release-tested. The
third-party VulkanMod renderer is not supported. Tiled 2X is intended for stationary scenes.
